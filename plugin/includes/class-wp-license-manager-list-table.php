<?php
/**
 * A copy of the WordPress base class for displaying a list of items in an ajaxified HTML table.
 *
 * The class is included in the plugin because it is marked @private and might change
 * any time according to the WordPress documentation.
 */
